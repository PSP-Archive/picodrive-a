...
// /*INLINE*/static void/*test*/ m68ki_exception_1010(void)
//void/*test*/ m68k_op_1010(void){	m68ki_exception_1010();}
	uint sr;

	sr = m68ki_init_exception();
	m68ki_stack_frame_3word(REG_PPC, sr);//, EXCEPTION_1010);
	m68ki_jump_vector(EXCEPTION_1010);

	/* Use up some clock cycles and undo the instruction's cycles */
	m68ki_remaining_cycles -=(4/*m68ki_exception_cycle_table_000[EXCEPTION_1010]*/ - m68ki_cycles[REG_IR]);
}
...
// /*INLINE*/static void/*test*/ m68ki_exception_1111(void)
//void/*test*/ m68k_op_1111(void){	m68ki_exception_1111();}
	uint sr;

	sr = m68ki_init_exception();
	m68ki_stack_frame_3word(REG_PPC, sr);//, EXCEPTION_1111);
	m68ki_jump_vector(EXCEPTION_1111);

	/* Use up some clock cycles and undo the instruction's cycles */
	m68ki_remaining_cycles -=(4/*m68ki_exception_cycle_table_000[EXCEPTION_1111]*/ - m68ki_cycles[REG_IR]);
}
...
static void m68k_op_abcd_8_rr(void)
{
	...
	FLAG_X = FLAG_C = ((res>0x99)?CFLAG_SET:CFLAG_CLEAR);
	if(FLAG_C) res -= 0xa0;
...
static void m68k_op_asr_8_r(void)
{
	...
	if(shift != 0)
	{
		m68ki_remaining_cycles -=(shift<<CYC_SHIFT);
...
static void m68k_op_bhi_8(void)
{
	...
	m68ki_remaining_cycles -=(CYC_BCC_NOTAKE_B);
}
...
static void m68k_op_bhi_16(void)
{
	...
	REG_PC += 2;
	m68ki_remaining_cycles -=(CYC_BCC_NOTAKE_W);
}
...
{
	m68ki_branch_8(MASK_OUT_ABOVE_8(REG_IR));
	if(REG_PC == REG_PPC)	m68ki_remaining_cycles = 0;
}
